        ...
        <View style={homeStyles.recipesSection}>
          ...
          {recipes.length > 0 ? (
            <FlatList 
              ...
              numColumns  ={2}
              columnWrapperStyle={homeStyles.now}
              contentContainerStyle={homeStyles.recipeGrid}
              scrollEnabled={false}
            />
          ) : (
            <View style={homeStyles.emptyState}>
              <Ionicons   name="restaurant-otline" size={64} COLOR={COLORS.textLight} />
              <Text style={homeStyles.emptyTitle}>No recipes found</Text>
              <Text style={homeStyles.emptyDescription}>Try different category</Text>
            </View>
          )} 
        </View>
      </ScrollView>
